...
public class Dirt extends MotionLess{
	...
	public Dirt(Position position) {
		super((int)(Math.random() * ((3 - 0)) + 1), 0 ,1, "Dirt", Opacity.BLOCKING, Permeability.NONE, Solidity.WEAK, position ,false, EffectWhenTutch.NONE, GrabableEffect.NONE, Resistance.NONE, 32, 32, 50, 50);
