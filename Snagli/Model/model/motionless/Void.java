...
public class Void extends MotionLess{
	...
	public Void(Position position) {
		super(0, 0, 1, "Void", Opacity.PENETRABLE, Permeability.NONE, Solidity.UNBREKABLE, position ,false, EffectWhenTutch.NONE, GrabableEffect.NONE, Resistance.NONE, 50, 50, 50, 50);
